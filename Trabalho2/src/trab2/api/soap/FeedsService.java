...
public interface FeedsService {
	...
	@WebMethod
	long postMessageOtherDomain(String user, String secret, Message msg) throws FeedsException;

	@WebMethod
	void subUserOtherDomain(String user, String userSub, String secret) throws FeedsException;

	@WebMethod
	void unsubUserOtherDomain(String user, String userSub, String secret) throws FeedsException;
}
