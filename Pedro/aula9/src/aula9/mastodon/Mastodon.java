...
public class Mastodon implements Feeds {
    ...
    private static final String clientKey = "9mOrILbUqWk9_nmUOV1PQtTxA-WAVG6IJNc9Uymp8hw";
    private static final String clientSecret = "yUHLW9fMXEZRn_tG1t2I-OPcPuvS4OfaoiMqjyucEQU";
    private static final String accessTokenStr = "rUK6u0yC2mt3KS8iaqOtJr36Vgv7jbdDk6eXjE55q1E";
    ...
    public Result<Void> removeFromPersonalFeed(String user, long mid, String pwd) {
        try {
            final OAuthRequest request = new OAuthRequest(
                    Verb.DELETE, getEndpoint(STATUSES_PATH) + "/" + mid);
