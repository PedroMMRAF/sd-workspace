...
public interface UsersService {
	...
	static final String INTERFACE = "aula8.api.soap.UsersService";
	 ...
	 * will be
	 * considered as if the the fields is not to be modified (the id cannot be
	 * modified).
	 * 
	 * @param name name of the user
	 ...
	 * should be eventually removed (asynchronous
	 * deletion is ok).
	 * 
	 * @param name name of the user
	 * @param pwd  password of the user
